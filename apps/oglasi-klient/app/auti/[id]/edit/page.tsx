...
import { updateVehicle, getVehicleById, deleteVehicle } from '@oglasi/server-actions'
...
export default function EditVehiclePage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await updateVehicle(session.user.id, params.id, adData, vehicleData)
      router.push(`/auti/${params.id}`)
    } catch (err: any) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await deleteVehicle(session.user.id, params.id)
      router.push('/auti')
    } catch (err: any) {
      setError(err.message || 'Došlo je do greške')
      setDeleting(false)
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Ažurirajte informacije o vozilu</p>
        </div>
        <Button
          variant="destructive"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  defaultValue={vehicle.engineVolume || ''}
                  placeholder="2000"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  id="airbags"
                  name="airbags"
                  defaultChecked={vehicle.airbags}
                  className="rounded"
                />
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  defaultChecked={vehicle.airConditioning}
                  className="rounded"
                />
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  id="parkingSensors"
                  name="parkingSensors"
                  defaultChecked={vehicle.parkingSensors}
                  className="rounded"
                />
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  id="cruiseControl"
                  name="cruiseControl"
                  defaultChecked={vehicle.cruiseControl}
                  className="rounded"
                />
        ...
        <div className="flex gap-4">
          ...
          <Link href={`/auti/${params.id}`} className="flex-1">
